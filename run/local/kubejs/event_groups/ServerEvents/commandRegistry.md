...
| ---- | ---------- | ----------- | ------- |
| register | LiteralArgumentBuilder<ServerCommandSource> |  | LiteralCommandNode<ServerCommandSource> | ✘ |
| getArguments |  |  | ClassWrapper<ArgumentTypeWrappers> | ✘ |
| getRegistry |  |  | CommandRegistryAccess | ✘ |
| getBuiltinSuggestions |  |  | ClassWrapper<CommandSource> | ✘ |
| isForSinglePlayer |  |  | boolean | ✘ |
| isForMultiPlayer |  |  | boolean | ✘ |
| getCommands |  |  | ClassWrapper<CommandManager> | ✘ |
| exit | Object |  | Object | ✘ |
| exit |  |  | Object | ✘ |
